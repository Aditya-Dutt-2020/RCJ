...
//  Serial.println(rms);
  ...
  //setSpeeds(tP+correction, tP-correction);
  //proportionalTurn(FORW, FORW);
...
//       Serial.println(qtr.readLineBlack(sensorValues));
    ...
    {
//      Serial.println("Never mind, no Left turn, just a gap");
      straight(2, 255);
...
//      Serial.println("Back on line after left turn");
      continue;
    }
    delay(200);
